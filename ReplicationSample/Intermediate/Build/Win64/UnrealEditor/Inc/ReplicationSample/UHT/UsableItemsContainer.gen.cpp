...
template<> REPLICATIONSAMPLE_API UScriptStruct* StaticStruct<FInteractableItemEntity>()
{
...
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UScriptStruct_FInteractableItemEntity_Statics::NewProp_itemsAmount = { "itemsAmount", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FInteractableItemEntity, itemsAmount), METADATA_PARAMS(Z_Construct_UScriptStruct_FInteractableItemEntity_Statics::NewProp_itemsAmount_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInteractableItemEntity_Statics::NewProp_itemsAmount_MetaData)) };
	...
	{
		P_GET_TARRAY_REF(FInteractableItemEntity,Z_Param_Out_Representation);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetParams(Z_Param_Out_Representation);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UsableItemsContainer_GetRepresentation_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FInteractableItemEntity, METADATA_PARAMS(nullptr, 0) }; // 3100447343
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UsableItemsContainer_SetParams_Statics::NewProp_Representation_Inner = { "Representation", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FInteractableItemEntity, METADATA_PARAMS(nullptr, 0) }; // 3100447343
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UsableItemsContainer_SetParams_Statics::NewProp_Representation = { "Representation", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(sableItemsContainer_eventSetParams_Parms, Representation), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UsableItemsContainer_SetParams_Statics::NewProp_Representation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UsableItemsContainer_SetParams_Statics::NewProp_Representation_MetaData)) }; // 3100447343
...
#endif
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_SelectedIndex;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UsableItemsContainer_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UsableItemsContainer_GetRepresentation, "GetRepresentation" }, // 1660186164
		...
		{ &Z_Construct_UFunction_UsableItemsContainer_SetParams, "SetParams" }, // 488080170
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UsableItemsContainer_Statics::NewProp_EntitiesRepresentation_Inner = { "EntitiesRepresentation", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FInteractableItemEntity, METADATA_PARAMS(nullptr, 0) }; // 3100447343
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UsableItemsContainer_Statics::NewProp_SelectedIndex_MetaData[] = {
		{ "ModuleRelativePath", "UsableItems/UsableItemsContainer.h" },
	};
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UsableItemsContainer_Statics::NewProp_SelectedIndex = { "SelectedIndex", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UsableItemsContainer, SelectedIndex), METADATA_PARAMS(Z_Construct_UClass_UsableItemsContainer_Statics::NewProp_SelectedIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UsableItemsContainer_Statics::NewProp_SelectedIndex_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UsableItemsContainer_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UsableItemsContainer_Statics::NewProp_SelectedIndex,
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ReplicationSample_Source_ReplicationSample_UsableItems_UsableItemsContainer_h_Statics::ScriptStructInfo[] = {
		{ FInteractableItemEntity::StaticStruct, Z_Construct_UScriptStruct_FInteractableItemEntity_Statics::NewStructOps, TEXT("InteractableItemEntity"), &Z_Registration_Info_UScriptStruct_InteractableItemEntity, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInteractableItemEntity), 3100447343U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ReplicationSample_Source_ReplicationSample_UsableItems_UsableItemsContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UsableItemsContainer, UsableItemsContainer::StaticClass, TEXT("UsableItemsContainer"), &Z_Registration_Info_UClass_UsableItemsContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UsableItemsContainer), 3188381204U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ReplicationSample_Source_ReplicationSample_UsableItems_UsableItemsContainer_h_999045258(TEXT("/Script/ReplicationSample"),
